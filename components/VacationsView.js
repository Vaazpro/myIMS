    ...
    render() {
        return (
            <View style={[Styles.shadow, {height: 60, flexDirection: 'row', borderRadius: 5, elevation: 1,marginBottom: 20,backgroundColor: '#F2F2F2'}]}>
                <View style= {{flex: 2, paddingLeft: 10, borderTopLeftRadius: 5 , flexDirection: 'column', borderBottomLeftRadius:5, borderLeftColor: 'purple', borderLeftWidth: 2,justifyContent:'center'}}>
                    <View style={{justifyContent:'flex-end', flex:1}}>
                        <Text style={{fontSize: 15}}>05</Text>
                    </View>
                    <View style={{justifyContent:'center', flex:1}}>
                        <Text style={{fontSize: 10}}>Novembro</Text>
                    </View>
                ...
                <View style= {{flex: 8, flexDirection: 'column', justifyContent: 'center',paddingLeft:10}}>
                    <View style={{flex:1, flexDirection: 'row', alignItems:'flex-end'}}>
                        <View style={{flex: 1}}>
                            <Text style={{fontSize: 15}}>1 dia (8h)</Text>    
                        </View>
                    ...
                    <View style={{flex:1, justifyContent: 'center'}}>
                        <Text style={{fontSize: 10}}>Aprovado</Text>
                    </View>
                </View>   
