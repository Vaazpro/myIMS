    ...
    render() {
        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{flex:1}}>
                    <ScrollView scrollEnabled={true} alwaysBounceVertical={true} overScrollMode='always'>
