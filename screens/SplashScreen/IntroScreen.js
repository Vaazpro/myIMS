        ...
        return (
            <KeyboardAvoidingView style={{flex:1, backgroundColor: 'rgb(73, 144, 226)', justifyContent:'center', alignItems:'center'}} behavior="padding" enabled>
                ...
                <View style={{flex:1, marginBottom: 40, backgroundColor: 'rgb(73, 144, 226)', justifyContent: 'flex-start', alignItems:'center'}}>
                    ...
                    <TextInput value={this.state.username} onChangeText={(username) => this.setState({username: username})} onFocus={()=> {this.setState({topMyIMS: '-10%'})}} placeholder={PT.LABEL_PLACEHOLDER_USERNAME} placeholderTextColor='white' underlineColorAndroid='transparent' style={{color:'white', width: '100%', textAlign: 'center'}}></TextInput>
                    </Animated.View>
                    ...
                    <TextInput value={this.state.password} onChangeText={(password) => this.setState({password: password})} onFocus={()=> {this.setState({topMyIMS: '-10%'})}} underlineColorAndroid='transparent' placeholder={PT.LABEL_PLACEHOLDER_PASSWORD} secureTextEntry={true} placeholderTextColor='white' style={{color:'white', width: '100%', textAlign: 'center'}}></TextInput>
                    </Animated.View>
